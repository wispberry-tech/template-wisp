...
| [Bytecode & VM](vm.md) | Compile pipeline, immutable bytecode, pooled VM, concurrency guarantees |
...
| [Examples](examples.md) | Walkthrough of the Juicebar reference app (shop + blog + transactional emails) |
