# Grove Layout Inheritance — Implementation Plan
...
| File | Change |
|------|--------|
| `pkg/grove/inheritance_test.go` | NEW — all Plan 5 tests |
...
**Files:**
- Create: `pkg/grove/inheritance_test.go`

Tests fail until implementation is added.

- [ ] **Step 1: Create `pkg/grove/inheritance_test.go`**
...
func TestInheritance_SuperWithVariables(t *testing.T) {
	...
	require.Equal(t, "Hello, Grove!", renderInherit(t, store, "child.html", grove.Data{"name": "Grove"}))
}
